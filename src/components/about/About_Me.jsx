...
const About_Me = () => {
    return (
        <div >
            ...
            <p className="px-6 lg:px-0 lg:text-xl font-medium text-white text-justify flex flex-col lg:leading-8 mt-9">Hi, I’m a passionate MERN Stack Developer with a strong foundation in building scalable, responsive, and user-centric web applications. I specialize in MongoDB, Express.js, React.js, and Node.js, and enjoy turning complex problems into clean, efficient solutions.
