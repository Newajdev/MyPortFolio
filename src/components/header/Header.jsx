...
const Header = () => {
    return (
        <div className='h-[520px] lg:h-[779px]'>
            <div className=''>
                <div className='relative'>
                    ...
                    <img className='absolute top-[-15px] lg:top-[-20px] right-[90px] lg:right-[380px] w-8 lg:w-10 rotate-180' src={Ornament} alt="" />

                    <img className='absolute top-[58px] lg:top-[180px] left-[0px] lg:left-[30px] w-8 lg:w-20' src={Ornament} alt="" />
                </div>
                <div className='relative'>
